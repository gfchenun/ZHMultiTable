...
@implementation ZHMultiTabViewBar
#pragma mark - system
...
- (void)zh_reloadTabBar {
    ...
    for (u_int8_t index = 0; index < count; index++) {
        UIButton *btn = [self.delegate tabViewBar:self buttonForIndex:index];
    ...
    [self zh_tabDidScrollToIndex:_curIndex];
}
...
- (void)configureSubviews {
    ...
    _indicatorView.backgroundColor = BCComConfig.config.defaultColor;
